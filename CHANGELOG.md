# v2.14.1
- [#228](https://github.com/xmrig/fruityminer-amd/issues/228#issuecomment-472287697) Fixed macOS support.
- [#235](https://github.com/xmrig/fruityminer-amd/issues/235) Fixed autoconf for `cn/r` and other recently added algorithms.
- [#241](https://github.com/xmrig/fruityminer-amd/issues/241) Fixed memory leak if used `cn/r` algorithm.

# v2.14.0
- **[#227](https://github.com/xmrig/fruityminer-amd/pull/227) Added new algorithm `cryptonight/rwz`, short alias `cn/rwz` (also known as CryptoNight ReverseWaltz), for upcoming [Graft](https://www.graft.network/) fork.**
...
# v2.12.0
- [#218](https://github.com/xmrig/fruityminer-amd/pull/218) Added support for new algorithm `cryptonight/wow`, short alias `cn/wow` (also known as CryptonightR), for upcoming [Wownero](http://wownero.org) fork on February 14.
- Improved `cryptonight/gpu` performance.

# v2.11.1
* Fixed regression, algorithm `cn-plex/upx2` was broken in v2.11.0.
...
# v2.9.3
- [#211](https://github.com/xmrig/fruityminer-amd/pull/211) Fixed `cn/half` compute errors.
...
- [#203](https://github.com/xmrig/fruityminer-amd/pull/203) Fixed GPU errors with worksize != 8 on cn-heavy.

# v2.8.6
- **Improved `cn-heavy`, `cn-heavy/xhv` perfomance up to 8% since v2.8.5 and up to 16% since v2.8.4, thanks [@SChernykh](https://github.com/SChernykh)**, pull requests [#187](https://github.com/xmrig/fruityminer-amd/pull/187), [#189](https://github.com/xmrig/fruityminer-amd/pull/189), [#190](https://github.com/xmrig/fruityminer-amd/pull/190), [#191](https://github.com/xmrig/fruityminer-amd/pull/191), [#192](https://github.com/xmrig/fruityminer-amd/pull/192) and [#193](https://github.com/xmrig/fruityminer-amd/pull/193).
- **[#195](https://github.com/xmrig/fruityminer-amd/pull/195) Fixed hashrate fluctuations. It's no longer necessary to use different intensities per thread.**
...
# v2.8.5
- [#185](https://github.com/xmrig/fruityminer-amd/pull/185) **Improved `cn-heavy`, `cn-heavy/xhv` and `cn-heavy/tube` perfomance up to 8%, thanks [@SChernykh](https://github.com/SChernykh).**
- [#271](https://github.com/xmrig/fruityminer-proxy/issues/271) Fixed pool options cascading when use mixed configuration: config file and command line.
- Improved AMD Vega 56 auto configuration for `cn/2`.

# v2.8.4
- **Improved AMD Vega autoconfig (double threads & higher intensity).**
- Fixed broken OpenCL code for `cn-upx` and `cn-heavy` (regression since v2.8.2).
- [#166](https://github.com/xmrig/fruityminer-amd/pull/166) Fixed graceful OpenCL shutdown.
...
# v2.8.2
- [#167](https://github.com/xmrig/fruityminer-amd/issues/167) Fixed wrong hashrate in `GET /1/threads` API endpoint.
- [#168](https://github.com/xmrig/fruityminer-amd/issues/168) Fixed broken AMD OpenCL compile (old driver bug).

# v2.8.1
- [#156](https://github.com/xmrig/fruityminer-amd/issues/156) Added CMake option to disable strict OpenCL cache.
...
- [#162](https://github.com/xmrig/fruityminer-amd/issues/162) Extended `opencl-platform` option.
...
# v2.7.3-beta
- [#145](https://github.com/xmrig/fruityminer-amd/issues/145) Added runtime linking with OpenCL ICD, **AMD APP SDK not required anymore**.
- [#140](https://github.com/xmrig/fruityminer-amd/issues/140) `cryptonight-upx/ipbc` replaced to `cryptonight-heavy/tube` for **Bittube (TUBE)**.
- [#128](https://github.com/xmrig/fruityminer-amd/issues/128) Improved `cryptonight/msr` support, removed usage restrictions.
...
# v2.7.2-beta
- [#132](https://github.com/xmrig/fruityminer-amd/issues/132) Fixed regression, command line option `--opencl-platform` was broken.

# v2.7.1-beta
- [#130](https://github.com/xmrig/fruityminer-amd/issues/130) **Added OpenCL cache support**.
...
- [#128](https://github.com/xmrig/fruityminer-amd/issues/128) **Added support for new cryptonight variant msr** (`cn/msr`) also known as `cryptonight-fast` for Masari fork.
- [#126](https://github.com/xmrig/fruityminer-amd/issues/126) Fixed regression, command line option `--print-platforms` was broken.
- [#127](https://github.com/xmrig/fruityminer-amd/issues/127) Fixed regression, miner was not exit if OpenCL errors happen.

# v2.7.0-beta
- **Added support for cryptonight-upx variant ipbc** (`cn-upx/ipbc`) for BitTube also was known as IPBC.
- **Added support for cryptonight variant xtl** (`cn/xtl`) for Stellite.
- Added [config options](https://github.com/xmrig/fruityminer-amd/blob/dev/doc/THREADS.md) `strided_index`, `mem_chunk` and `comp_mode`.
...
# v2.4.3-beta2
 ...
 - Fixed 32 bit build.
 - [#2](https://github.com/xmrig/fruityminer-amd/issues/2) Fixed Linux build.
 - [#3](https://github.com/xmrig/fruityminer-amd/issues/3) Fixed macOS build.
