...
#define VARIANT_UPX2 10 // CryptoNight Turtle (TRTL)
#define VARIANT_GPU  11 // CryptoNight-GPU (Ryo)

#define CRYPTONIGHT       0 /* CryptoNight (2 MB) */
#define CRYPTONIGHT_UPX  1 /* CryptoNight (1 MB) */
#define CRYPTONIGHT_HEAVY 2 /* CryptoNight (4 MB) */
#define CRYPTONIGHT_PLEX  3 /* CryptoNight (256 KB) */
...
{
#   if (ALGO == CRYPTONIGHT || ALGO == CRYPTONIGHT_PLEX)
    ulong a[2], b[4];
    __local uint AES0[256], AES1[256], AES2[256], AES3[256];
